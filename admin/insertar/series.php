...
<body>
    ...
    <div class="container d-flex align-items-center vh-100">
        <form action="./insert.php?tabla=series" method="post" enctype="multipart/form-data" class="w-100">
            <div class="row">
                <div class="col-12 text-center mb-3">
                    <table align="center">
                        ...
                        <tr>
                            <td style="color: #fff;">Año salida: </td>
                            <td>
                                <input class="form-control" type="text" name="año_salida" id="año_salida" style="width: 120%;" size="4" required>
                            </td>
                        </tr>
                        
                        <tr>
                            <td style="color: #fff;">Año fin: </td>
                            <td>
                                <input class="form-control" type="number" name="año_fin" id="año_fin" style="width: 120%;" size="4" required>
                            </td>
                        </tr>
