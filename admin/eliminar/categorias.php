    ...
    <div class="container mt-5">
        <div class="row justify-content-center">
            <div class="col-12 col-md-6">
                <form action="./delete.php?tabla=categorias" method="post" enctype="multipart/form-data">
                    <div class="row mb-3">
                            ...
                            <table class="table table-dark table-hover">
                                ...
                                <tbody>
                                    ...
                                    while ($row = mysqli_fetch_assoc($registros)) {
                                        echo '
                                    <tr>
                                        <td><input class="form-check-input" name="idcategorias[]" type="checkbox" value="' . $row['idcategoria'] . '"></td>
